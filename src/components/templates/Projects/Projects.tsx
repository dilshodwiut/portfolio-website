...
export default function Projects(
  ...
  return (
    <div className={classes.projects__list}>
      <Project
        image={{ src: "/goodzone2.png", alt: "Goodzone" }}
        title={
          <Image
        ...
        description="Goodzone - Internet shop of household appliances in Uzbekistan."
        services={[
          {
            type: "admin",
            image: { src: "/setting.png", alt: "Admin Panel" },
          },
          { type: "website", image: { src: "/global.png", alt: "Web" } },
        ]}
        tags={[
          {
            text: "Delivery",
            color: "red",
            image: { src: "/shopping-cart.png", alt: "Shopping Cart" },
          },
        ]}
      />
    </div>
